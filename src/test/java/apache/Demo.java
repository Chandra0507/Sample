package apache;
	...
	import java.io.File;
//created word document tables using java code
...
import org.apache.poi.xwpf.usermodel.XWPFTableRow;  
	public class Demo {  
		public static void main(String[] args)throws Exception {
			...
			FileOutputStream out = new FileOutputStream (new File("C:\\Users\\TG1689\\Desktop\\Table/TG.docx"));
			XWPFParagraph paragraph = doc.createParagraph();
//			XWPFRun run = paragraph.createRun();
//			run.setText("this is my word Document");
			doc.write(out);
			out.close();
